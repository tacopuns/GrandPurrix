...
namespace sc.splinemesher.pro.editor
{
    public class HelpWindow : EditorWindow
    {
        ...
        [MenuItem("Help/Spline Mesher Pro", false, 0)]
        ...
        private void OnGUI()
        {
            ...
            EditorGUILayout.LabelField("<size=24>Spline Mesher Pro</size>", UI.Styles.Header);
